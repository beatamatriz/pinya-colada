...
{
    #region VARS
    public DialogueContainer dialogueContainerC;
    public MobileUp mobileUp;
    ...
    public void Interact(VIDE_Assign dialogue)
    {
        ...
        print("Next node");
        if (dialogueContainerC && data != null)
            dialogueContainerC.PickBack(data.isPlayer);
    }
    ...
    void UpdateUI(VD.NodeData data)
    {
        ...
        { b.transform.GetChild(0).GetComponent<Text>().text = ""; b.transform.GetChild(0).GetComponent<Text>().color = Color.white; }
